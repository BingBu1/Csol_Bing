...
#ifdef _WIN32
//#define EXPORT _declspec(dllexport)T
#define EXPORT
#else
#define EXPORT
#endif
...
public:
	...
	virtual void Dontk();
	virtual void Dontk2();
	virtual void Dontk3();//10
	virtual void Precache(void) {}
	virtual void Restart(void) {}
	virtual void KeyValue(KeyValueData *pkvd) { pkvd->fHandled = FALSE; }
	virtual int Save(CSave &save);//20
	virtual int Restore(CRestore &restore);
	virtual int ObjectCaps(void) { return FCAP_ACROSS_TRANSITION; }
	virtual void Activate(void) {}
	virtual void SetObjectCollisionBox(void);//30
	virtual int Classify(void) { return CLASS_NONE; }
	virtual void DeathNotice(entvars_t *pevChild) {}
	virtual void Dontk4();
	virtual void Dontk5();
	virtual void TraceAttack(entvars_t *pevAttacker, float flDamage, Vector vecDir, TraceResult *ptr, int bitsDamageType);
	virtual int TakeDamage(entvars_t* pevInflictor, entvars_t* pevAttacker, float flDamage, int bitsDamageType, DamageBit* bitsDamageClass);
	...
	virtual int GetEcxAdd_15C() = 0;
	virtual int Unk(float A1, float A2, float A3, float A4, float A5, float A6) = 0;
	virtual int RetTrue(int Unk) = 0;
	virtual int Xoreax() = 0;
	virtual int Xoreax3() = 0;
	virtual int GetEcxAdd_A0() = 0;
	...
	virtual int NN() = 0;
	virtual int NN1(float A1, float A2, float A3, float A4, float A5, float A6) = 0;
	virtual int NN2(int Unk) = 0;
	virtual int NN3() = 0;
	virtual int NN4() = 0;
	virtual int NN5() = 0;
...
public:
	int *ThisIsDontN;				//4
	entvars_t *pev;					//8
	CBaseEntity *m_pGoalEnt;		//C
	CBaseEntity *m_pLink;			//10
