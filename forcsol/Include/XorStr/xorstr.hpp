...
#define constxorstr_(str) xorstr(str).crypt_get_const()
...
namespace jm {
    ...
    public:
        ...
        XORSTR_FORCEINLINE const_pointer crypt_get_const() const noexcept {
            return reinterpret_cast<const_pointer>(crypt_get());
        }
